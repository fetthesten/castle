...
func _enter_tree():
	...
	$'ToolButton'.connect('button_down', self, 'open_file_dialog')
	$'FileDialog'.connect('file_selected', self, 'open_tex')
	$'Control Grid/BPreviewTiles'.connect('button_down', self, 'update_tile_preview')
	$TileSheetTex/TilePreview.connect('gui_input', self, 'tile_preview_input')
	$'Tile Preview Grid/BCreateTilesheet'.connect('button_down', self, 'create_tilesheet')
	$'Tile Preview Grid/BEditSelectedTiles'.connect('button_down', self, 'edit_selected_tiles')
	$'Tile Preview Grid/BSaveTilesheet'.connect('button_down', self, 'save_tilesheet')

func open_file_dialog():
	$'FileDialog'.popup()

func open_tex(file_name):
	$TileSheetTex.texture = load(file_name)
	$"Control Grid".visible = true
	$"Tile Preview Grid".visible = true
...
func _on_PopupTimer_timeout():
	$TileSheetTex/TilePopup.visible = false
